...
{   my $email               = shift;
    ...
    {   $outputHTML .=      "<tr>
        ...
        {   $outputHTML .= "<td>&nbsp;<a href=\"/SciMiner1.1/$row[5]\" onmouseover=\"Tip('Click here to see query ID #$row[0] result')\" onmouseout=\"UnTip()\"><img src=\"/SciMiner1.1/SciMiner/Images/R.jpg\"></a></td>\n";
