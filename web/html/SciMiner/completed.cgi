...
{   my $email               = shift;
    ...
    {	$outputHTML .=      "<tr>
        ...
        {   $outputHTML .= "<td><a href=\"$row[7]\" onmouseover=\"Tip('Click here to see query ID #$row[0] result')\" onmouseout=\"UnTip()\"><img src=\"Images/R.jpg\"></a></td>\n";
...
{   my $email               = shift;
    ...
    my $outputHTML  = "<p class=\"titleBarName1\">(<b>Section_2</b>) Here are the list of your previous SciMiner anlaysis results. (completed only)<br>
                        ...
                        <table border=\"1\" width=\"870\">
                            <tr class=\"tableHeader1\">
                                ...
                                <th width=\"100\" onmouseover=\"Tip('<b>Tests</b>: Types of post-mining analyses done here<br><img src=&quot;Images/G.jpg&quot;>: Gene (Target) list<br><img src=&quot;Images/O.jpg&quot;>: Gene Ontology<br><img src=&quot;Images/M.jpg&quot;>: MeSH Term<br><img src=&quot;Images/P.jpg&quot;>: Pathways<br><img src=&quot;Images/I.jpg&quot;>: Protein-Protein Interactions<br>')\" onmouseout=\"UnTip()\">
    ...
    {   $outputHTML 	.=  "<tr>
		...
		{	$outputHTML	.= "<img src=\"Images/G.jpg\" onmouseover=\"Tip('<img src=&quot;Images/G.jpg&quot;>: Gene (Target) list')\" onmouseout=\"UnTip()\">";
		}else
		{	$outputHTML	.= "<img src=\"Images/BLANK.jpg\">";
		}
		if ((defined $row[6]) && ($row[6] == 1))
		{	$outputHTML	.= "<img src=\"Images/O.jpg\" onmouseover=\"Tip('<img src=&quot;Images/O.jpg&quot;>: Gene Ontology')\" onmouseout=\"UnTip()\">";
		}else
		{	$outputHTML	.= "<img src=\"Images/BLANK.jpg\">";
		}
		if ((defined $row[7]) && ($row[7] == 1))
		{	$outputHTML	.= "<img src=\"Images/M.jpg\" onmouseover=\"Tip('<img src=&quot;Images/M.jpg&quot;>: MeSH Term')\" onmouseout=\"UnTip()\">";
		}else
		{	$outputHTML	.= "<img src=\"Images/BLANK.jpg\">";
		}
		if ((defined $row[8]) && ($row[8] == 1))
		{	$outputHTML	.= "<img src=\"Images/P.jpg\" onmouseover=\"Tip('<img src=&quot;Images/P.jpg&quot;>: Pathway')\" onmouseout=\"UnTip()\">";
		}else
		{	$outputHTML	.= "<img src=\"Images/BLANK.jpg\">";
		}
		if ((defined $row[9]) && ($row[9] == 1))
		{	$outputHTML	.= "<img src=\"Images/I.jpg\" onmouseover=\"Tip('<img src=&quot;Images/I.jpg&quot;>: Protein-Protein Interactions')\" onmouseout=\"UnTip()\">";
		}else
		{	$outputHTML	.= "<img src=\"Images/BLANK.jpg\">";
		}						
		$outputHTML .= "</td>";
		...
		{	$outputHTML	.= "<td>&nbsp;<a href=\"$row[4]\" onmouseover=\"Tip('Click here to see analysis ID #$row[0] result')\" onmouseout=\"UnTip()\"><img src=\"Images/R.jpg\"></a></td>";
		}else
		{	$outputHTML	.= "<td>&nbsp;</td>";
		}
		
		# Delete button
    	$outputHTML .= "<td>&nbsp;<a href=\"#\" onclick=\"delete_analysis($row[0])\" onmouseover=\"Tip('Click here to delete query ID #$row[0] result')\" onmouseout=\"UnTip()\"><img src=\"Images/D.jpg\"></a></td>";
